...
// src/index.js
var PREFIX = "clearsight/";
var MAX_TTL = 900;
var KEY_PATTERN = /^clearsight\/[A-Za-z0-9._\-/]+$/;
function isSafeKey(key) {
  return typeof key === "string" && KEY_PATTERN.test(key) && !key.includes("..") && // no parent-directory traversal
...
var src_default = {
  async fetch(request, env) {
    ...
    if (Math.abs(Date.now() / 1e3 - Number(ts)) > 60) {
